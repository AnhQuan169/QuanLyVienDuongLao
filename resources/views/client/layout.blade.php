                                ...
                                <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src="{{asset('public/client/images/1025031-trn0010compv145.1062-1200.jpg')}}" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="{{asset('public/client/images/ant-man.jpg')}}" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="{{asset('public/client/images/1025031-trn0010compv145.1062-1200.jpg')}}" class="d-block w-100" alt="...">
                                        </div>
