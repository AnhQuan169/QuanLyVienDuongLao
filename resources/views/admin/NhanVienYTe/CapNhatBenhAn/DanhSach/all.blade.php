                                ...
                                @foreach ($elderly as $key => $usernd )
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{route('medical.records.add',$usernd->id_nguoicaotuoi)}}" type="button" class="btn btn-info edit-elderly" style="border-radius: 7px"><i class="fa fa fa-plus"></i></a>
                                            <a href="{{route('medical.records_personal.all',$usernd->id_nguoicaotuoi)}}" type="button" class="btn btn-success edit-elderly" style="border-radius: 7px"><i class="fa fa fa-list"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            @else
