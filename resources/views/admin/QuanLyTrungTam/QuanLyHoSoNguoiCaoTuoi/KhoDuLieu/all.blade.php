                    ...
                    <table id="example" class="display table table-bordered">
                        ...
                        <tbody>
                            @if (count($elderly) > 0)
                                @foreach ($elderly as $key => $usernd )
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{route('elderly.active.warehouse',$usernd->id_nguoicaotuoi)}}" type="button" class="btn btn-warning edit-elderly" style="border-radius: 7px"><i class="fa fa fa-lock"></i></a>
                                ...
                                @endforeach
                            @else
                                <td colspan="8" style="text-align: center">Trống</td>
                            @endif
                        </tbody>
                    </table>  
