                        ...
                        @if (count($dangkythamquan) > 0)
                            @foreach ($dangkythamquan as $key => $dky )
                                <tr>
                                    ...
                                    <td>{{$dky->soLuongDK}}</td>
                                    <td class="text-line-long">{{$dky->emailDK}}</td>
                                    ...
                                    <td class="text-center">
                                        <a href="{{route('browseapplication.detail',$dky->id_dangky)}}" type="button" class="btn btn-info update-browse" style="border-radius: 7px;margin-bottom: 5px"><i class="fa fa fa-info-circle"></i></a>
